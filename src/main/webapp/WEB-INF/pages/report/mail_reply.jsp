	 		...
	 		<div class="ibox-content">
 				<form class="form-horizontal" role="form" autocomplete="off" id="form-mail">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control textarea-mail-reply" name="content" style="resize:none; height: 150px;"></textarea>
                        </div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-4 col-sm-offset-2">
		                    <button type="button" class="btn btn-primary btn-mail-confirm">
