		...
		<div style="width: 600px; margin-right: auto; margin-left: auto">
			...
			<div name="xzContext" id="xzContext" style="overflow: auto;height:auto; font-size: medium;">
				<p>
					...
					<br>
					<span class="t2">1、按照《中国共产党纪律检查机关控告申诉工作条例》的相关规定，应当由广昌县纪委受理的党员、党组织违反党章和党内法规，违反党的路线、方针、政策和决议，利用职权谋取私利和其他败坏党风行为的检举、控告。 
						<br>2、按照《中华人民共和国行政监察法》相关规定，应当由广昌县纪委、市监察局举报中心受理的国家行政机关及其工作人员和国家行政机关任命的其他人员违反国家法律、法规、政策和决定、命令以及违反政纪行为的检举、控告。<br>3、对不属于纪检监察业务范围之内的问题将不予受理，请向有关部门反映。 
					</span>
					<br><br>
					...
					<p><span class="t2">1、网上举报只是反映问题的一种途径，还可以通过其他形式进行举报。 
						<br>通讯地址：广昌县纪委信访室 。 <br>邮政编码：344000<br>举报电话：
